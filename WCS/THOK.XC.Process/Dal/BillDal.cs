...
namespace THOK.XC.Process.Dal
{
    public class BillDal : BaseDal
    {
        ...
        public string CreateCancelBillOutTask(string TaskID, string BillNo, string OutBillNO)
        {
            ...
            {
                BillDao dao = new BillDao();
                return dao.CreateCancelBillOutTask(TaskID, BillNo, OutBillNO);
            }
        }
        ...
        public int UpdateInBillMasterFinished(string BillNo,string IsBill)
        {
            ...
            {
                BillDao dao = new BillDao();
                return dao.UpdateInBillMasterFinished(BillNo,IsBill);
            }
        }
        /// <summary>
        /// 单据出库完成
        ...
        public int UpdateOutBillMasterFinished(string BillNo)
        {
            ...
            {
                BillDao dao = new BillDao();
                return dao.UpdateOutBillMasterFinished(BillNo);
            }
        }
        /// <summary>
        /// 单据开始运行
        ...
        public DataTable GetPalletsTask(string filter)
        {
            ...
            {
                BillDao dao = new BillDao();
                return dao.GetPalletsTask(filter);
            }
        }
        ...
        public DataTable GetInBillInfo(string filter)
        {
            ...
            {
                BillDao dao = new BillDao();
                return dao.GetInBillInfo(filter);
            }
        }
        /// <summary>
        /// 获取出库单信息
        ...
        public DataTable GetBillOutTotal(string filter)
        {
            ...
            {
                BillDao dao = new BillDao();
                return dao.GetBillOutTotal(filter);
            }
        }
        /// <summary>
        /// 获取出库单明细
        ...
        public DataTable GetBillTotalDetail(string BillNo)
        {
            ...
            {
                BillDao dao = new BillDao();
                return dao.GetBillTotalDetail(BillNo);
            }
        }
    }
