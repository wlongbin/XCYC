...
namespace WMS.Controllers.Wms.WMS
{
    ...
    public class StockMoveSearchController : Controller
    {
        ...
        public ActionResult Details(int page, int rows, string flag, FormCollection collection)
        {
            ...
            var Billmaster = BillMasterService.GetDetails(page, rows, "5", flag, BILL_NO, BILL_DATE, BTYPE_CODE, WAREHOUSE_CODE, BILL_METHOD, CIGARETTE_CODE, FORMULA_CODE, STATE, OPERATER, OPERATE_DATE, CHECKER, CHECK_DATE, STATUS, BILL_DATEStar, BILL_DATEEND, SOURCE_BILLNO,"",BILLNOFROM ,BILLNOTO );
