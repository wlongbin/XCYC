...
namespace WMSWEBSERVICE.Tables
{
    ...
    /// 烟叶形态
    /// </summary>
    public class CMD_PRODUCT_STYLE
    {
        [DBField("id", EnumDBFieldUsage.PrimaryKey, "形态ID", "VARCHAR", "12", "必传")]
        public string id { get; set; }
        [DBField("code", EnumDBFieldUsage.None, "形态代码", "VARCHAR", "3", "必传")]
        public string code { get; set; }
        [DBField("name", EnumDBFieldUsage.None, "形态名称", "VARCHAR", "50", "必传")]
